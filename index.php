...
$src="http://www.<domain>.ac.in/dem/bpa/{$target_file}";

require_once "photoapi.php";
$apidata["dedection"]= json_decode(dedection("http://<domain>.ac.in/dem/bpa/{$target_file}"));
$apidata["face"]=json_decode(face("http://<domain>.ac.in/dem/bpa/{$target_file}"));
$apidata["emotion"]=json_decode(emotion("http://<domain>.ac.in/dem/bpa/{$target_file}"));
...
<head>
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
  <script src="http://<domain>.ac.in/dem/bpa/pretty.js"></script>
  <script src="http://<domain>.ac.in/dem/bpa/speak.js"></script>
  <script src="http://<domain>.ac.in/dem/bpa/underscore.js"></script>
